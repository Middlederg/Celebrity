...
namespace Celebrity.Forms.EdicionViews
{
    ...
    {
        private ICategoryRepository categoriasRepository;
        private IConceptosRepository repository;
        
        private IEnumerable<Concept> conceptos;
        private IEnumerable<Concept> GetConceptos
        {
            get
            {
        ...
        public FrmConceptosList(IConceptosRepository repository, ICategoryRepository categoriasRepository)
        {
            InitializeComponent();
        ...
        private void Fill()
        {
            ...
            foreach (var concepto in GetConceptos)
            {
                ...
                item.SubItems.Add(concepto.Difficulty.ToString());
                Lvw.Items.Add(item);
            }
        }
